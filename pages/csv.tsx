...
const retrieveLatestSalesData = async (): Promise<LatestSalesData> => {
  const res1 = await fetch("/api/azure/downloadSalesData")
  const res2 = await fetch("/api/azure/processSalesDataCSV", {
    method: "POST",
    body: (await res1.json()).data,
    headers: {
